...
class alignas(VL_CACHE_LINE_BYTES) Vfft2d_core___024root final : public VerilatedModule {
  public:
    ...
    struct {
        ...
        CData/*4:0*/ fft2d_core__DOT__row_idx;
        CData/*4:0*/ fft2d_core__DOT__col_idx;
        CData/*4:0*/ fft2d_core__DOT__feed_cnt;
        CData/*4:0*/ fft2d_core__DOT__recv_cnt;
        ...
        CData/*4:0*/ fft2d_core__DOT__u_fft1d__DOT__load_ptr;
        CData/*4:0*/ fft2d_core__DOT__u_fft1d__DOT__out_ptr;
        ...
        CData/*4:0*/ fft2d_core__DOT__u_fft1d__DOT__idx_a;
        CData/*4:0*/ fft2d_core__DOT__u_fft1d__DOT__idx_b;
        ...
        CData/*4:0*/ fft2d_core__DOT__u_fft1d__DOT__u_ctrl__DOT__j;
        CData/*4:0*/ fft2d_core__DOT__u_fft1d__DOT__u_ctrl__DOT__base;
        CData/*5:0*/ fft2d_core__DOT__u_fft1d__DOT__u_ctrl__DOT__span;
        CData/*5:0*/ fft2d_core__DOT__u_fft1d__DOT__u_ctrl__DOT__half;
        CData/*2:0*/ fft2d_core__DOT__u_fft1d__DOT__u_bfly__DOT__state;
        CData/*4:0*/ __Vfunc_fft2d_core__DOT__idx2d__0__r;
        CData/*4:0*/ __Vfunc_fft2d_core__DOT__idx2d__0__c;
        CData/*4:0*/ __Vfunc_fft2d_core__DOT__idx2d__1__r;
        CData/*4:0*/ __Vfunc_fft2d_core__DOT__idx2d__1__c;
        CData/*4:0*/ __Vfunc_fft2d_core__DOT__idx2d__2__r;
        CData/*4:0*/ __Vfunc_fft2d_core__DOT__idx2d__2__c;
        CData/*4:0*/ __Vfunc_fft2d_core__DOT__idx2d__3__r;
        CData/*4:0*/ __Vfunc_fft2d_core__DOT__idx2d__3__c;
        ...
        SData/*9:0*/ fft2d_core__DOT__out_ptr;
        SData/*9:0*/ fft2d_core__DOT__load_ptr;
    ...
    struct {
        ...
        SData/*9:0*/ __Vfunc_fft2d_core__DOT__idx2d__0__Vfuncout;
        SData/*9:0*/ __Vfunc_fft2d_core__DOT__idx2d__1__Vfuncout;
        SData/*9:0*/ __Vfunc_fft2d_core__DOT__idx2d__2__Vfuncout;
        SData/*9:0*/ __Vfunc_fft2d_core__DOT__idx2d__3__Vfuncout;
        ...
        VlUnpacked<SData/*15:0*/, 1024> fft2d_core__DOT__mem0_re;
        VlUnpacked<SData/*15:0*/, 1024> fft2d_core__DOT__mem0_im;
        VlUnpacked<SData/*15:0*/, 1024> fft2d_core__DOT__mem1_re;
        VlUnpacked<SData/*15:0*/, 1024> fft2d_core__DOT__mem1_im;
        VlUnpacked<SData/*15:0*/, 32> fft2d_core__DOT__u_fft1d__DOT__mem_re;
        VlUnpacked<SData/*15:0*/, 32> fft2d_core__DOT__u_fft1d__DOT__mem_im;
    };
