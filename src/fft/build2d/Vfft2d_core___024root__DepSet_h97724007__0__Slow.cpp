...
#endif
            VL_FATAL_MT("SV_fft2d_core.sv", 6, "", "Settle region did not converge.");
        }
...
VL_ATTR_COLD void Vfft2d_core___024root___ctor_var_reset(Vfft2d_core___024root* vlSelf) {
    ...
    vlSelf->fft2d_core__DOT__row_idx = VL_RAND_RESET_I(5);
    vlSelf->fft2d_core__DOT__col_idx = VL_RAND_RESET_I(5);
    vlSelf->fft2d_core__DOT__feed_cnt = VL_RAND_RESET_I(5);
    vlSelf->fft2d_core__DOT__recv_cnt = VL_RAND_RESET_I(5);
    vlSelf->fft2d_core__DOT__out_ptr = VL_RAND_RESET_I(10);
    vlSelf->fft2d_core__DOT__load_ptr = VL_RAND_RESET_I(10);
    ...
    vlSelf->fft2d_core__DOT__u_fft1d__DOT__load_ptr = VL_RAND_RESET_I(5);
    vlSelf->fft2d_core__DOT__u_fft1d__DOT__out_ptr = VL_RAND_RESET_I(5);
    ...
    vlSelf->fft2d_core__DOT__u_fft1d__DOT__idx_a = VL_RAND_RESET_I(5);
    vlSelf->fft2d_core__DOT__u_fft1d__DOT__idx_b = VL_RAND_RESET_I(5);
    ...
    vlSelf->fft2d_core__DOT__u_fft1d__DOT__u_ctrl__DOT__j = VL_RAND_RESET_I(5);
    vlSelf->fft2d_core__DOT__u_fft1d__DOT__u_ctrl__DOT__base = VL_RAND_RESET_I(5);
    vlSelf->fft2d_core__DOT__u_fft1d__DOT__u_ctrl__DOT__span = VL_RAND_RESET_I(6);
    vlSelf->fft2d_core__DOT__u_fft1d__DOT__u_ctrl__DOT__half = VL_RAND_RESET_I(6);
    ...
    vlSelf->__Vfunc_fft2d_core__DOT__idx2d__0__Vfuncout = VL_RAND_RESET_I(10);
    vlSelf->__Vfunc_fft2d_core__DOT__idx2d__0__r = VL_RAND_RESET_I(5);
    vlSelf->__Vfunc_fft2d_core__DOT__idx2d__0__c = VL_RAND_RESET_I(5);
    vlSelf->__Vfunc_fft2d_core__DOT__idx2d__1__Vfuncout = VL_RAND_RESET_I(10);
    vlSelf->__Vfunc_fft2d_core__DOT__idx2d__1__r = VL_RAND_RESET_I(5);
    vlSelf->__Vfunc_fft2d_core__DOT__idx2d__1__c = VL_RAND_RESET_I(5);
    vlSelf->__Vfunc_fft2d_core__DOT__idx2d__2__Vfuncout = VL_RAND_RESET_I(10);
    vlSelf->__Vfunc_fft2d_core__DOT__idx2d__2__r = VL_RAND_RESET_I(5);
    vlSelf->__Vfunc_fft2d_core__DOT__idx2d__2__c = VL_RAND_RESET_I(5);
    vlSelf->__Vfunc_fft2d_core__DOT__idx2d__3__Vfuncout = VL_RAND_RESET_I(10);
    vlSelf->__Vfunc_fft2d_core__DOT__idx2d__3__r = VL_RAND_RESET_I(5);
    vlSelf->__Vfunc_fft2d_core__DOT__idx2d__3__c = VL_RAND_RESET_I(5);
